    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _selectedUser =
              _assetData.assetUserName; // Set the selected user from assetData
...
*/
      ...
      Map<String, dynamic> updatedData = {
        ...
        "maintenanceDate": _editedLastMaintenanceDate.isNotEmpty
            ? _editedLastMaintenanceDate
            : _lastMaintenanceDateController.text,
        "assetDetail": _assetData.assetDetail,
        "targetBranch":
            _editedParentCode.isNotEmpty ? _editedParentCode : _branchcode,
        "targetLocation":
            _editedLocation.isNotEmpty ? _editedLocation : _editedLocationC,
        "transferType": _editedtranstype.isNotEmpty
            ? _editedtranstype
    ...
    return Scaffold(
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading
                      ? const SizedBox(
                          width: 28.0, // Adjust width as needed
                          height: 28.0, // Adjust height as needed
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              buildTypeaheadDropdowntransType(assetOptions,
                  _editedtranstypename), // Use the new method for the "Location" field
              buildTextField(
                'Barcode',
              ...
              buildTypeaheadDropdownUser(_assetStaffs,
                  _selectedUser), // Use the new method for the "Users" field
              buildTypeaheadDropdownBranch(_branchlist,
                  _selectedBranch), // Use the new method for the "Users" field
            ...
            TypeAheadFormField<String>(
              textFieldConfiguration: TextFieldConfiguration(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon:
                      Icon(Icons.arrow_drop_down), // Add the dropdown icon
                ),
                enabled:
